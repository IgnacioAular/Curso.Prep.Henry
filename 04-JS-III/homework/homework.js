...
function mesesDelAño(array) {
  ...
  //array buscando los meses de "Enero", "Marzo" y "Noviembre",
  ...
  for ( var i = 0; i < array.length; i++ )
    if ( array[i] === "Enero" || array[i] === "Marzo" || array[i] === "Noviembre" )
      monthFound.push(array[i]);
  
  if ( monthFound.length < 3 )
...
function breakStatement(numero) {
  ...
  //Guardar cada nuevo valor en un array. Devolver el array Si en algún momento el valor 
  //de la suma y la cantidad de iteraciones coinciden, debe interrumpirse la ejecución y 
  //devolver: "Se interrumpió la ejecución", Pista: usá el statement 'break'
  // Tu código:
  var i = 10;
  var msg = 'Se interrumpió la ejecución';
  var arr = [];
  do {
      numero = numero + 2;
      if( numero === i )
